...
#[Route('/afficheLesEmploye', name: 'aff_employe')]   
public function afficheLesEmploye(ManagerRegistry $doctrine)
{
    ...
    return $this->render('formation/ListeEmploye.html.twig', array('ensEmploye'=>$LesEmployes, 'message'=>$message));
}
